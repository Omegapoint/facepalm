...
INSERT INTO ACCOUNTS(EMAIL, USERNAME, FIRSTNAME, LASTNAME, PASSWORD) VALUES('dan.bergh.johnsson@omegapoint.com', 'dan', 'Dan', 'Bergh Johnsson', 'ponytail');
INSERT INTO ACCOUNTS(EMAIL, USERNAME, FIRSTNAME, LASTNAME, PASSWORD) VALUES('ddd@example.com', 'ddd', 'Eric', 'Evans', 'ubiquitous');
INSERT INTO ACCOUNTS(EMAIL, USERNAME, FIRSTNAME, LASTNAME, PASSWORD) VALUES('dddeu@example.com', 'dddeu', 'DDD', 'Europe', 'ddsec');
...
INSERT INTO FRIENDSHIPS(ID, USER_ID, FRIEND_ID, FRIENDS_SINCE) VALUES(4, 'ddd', 'dan', '2015-12-24');
INSERT INTO FRIENDSHIPS(ID, USER_ID, FRIEND_ID, FRIENDS_SINCE) VALUES(5, 'dddeu', 'ddd', '2016-01-28');
